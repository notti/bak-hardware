...
#! /usr/bin/perl
    ...
    if($no_synthesis == 0)
    {
        ...
        if($use_xst == 1)
        {
            ...
            print SCR_FILE "-p xc5vfx70t-1ff1136\n";
    ...
    if($no_ngdbuild == 0)
    {
        ...
        if($use_ngc == 1)
        {
            system ("ngdbuild -uc ../ucf/example_mgt_top.ucf -p xc5vfx70t-ff1136-1 example_mgt_top.ngc example_mgt_top.ngd");
        }
        else
        {
            system ("ngdbuild -uc ../ucf/example_mgt_top.ucf -p xc5vfx70t-ff1136-1 example_mgt_top.edf example_mgt_top.ngd");
        }
    }
    ...
    if($no_map == 0)
    {
        system("map -p xc5vfx70t-ff1136-1 -timing -o example_mgt_top_unrouted.ncd example_mgt_top.ngd example_mgt_top.pcf");
    }
